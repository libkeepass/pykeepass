...
def find_groups_by_path(
    self, group_path_str=None, regex=False, flags=None, group=None, first=False
):
    """@private"""
    return self.find_groups(
...
def find_groups_by_uuid(
    self, uuid, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_groups(
...
def find_groups_by_notes(
    self, notes, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_groups(
...
def find_entries_by_title(
    self, title, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
...
def find_entries_by_username(
    self, username, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_entries(
        username=username,
...
def find_entries_by_password(
    self, password, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_entries(
        password=password,
...
def find_entries_by_url(
    self, url, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_entries(
...
def find_entries_by_path(
    self, path, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_entries(
...
def find_entries_by_string(
    self, string, regex=False, flags=None, group=None, history=False, first=False
):
    """@private"""
    return self.find_entries(
        string=string,
